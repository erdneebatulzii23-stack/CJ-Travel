...
async function registerUser() {
    ...
    const userData = {
        ...
        role: roleInput.toLowerCase(), // Зөрүү гарахаас сэргийлж жижиг үсгээр хадгална
    ...
    try {
        ...
        if (response.ok) {
            ...
            window.location.replace('login.html'); // .href-ийг .replace-ээр сольсон
        } else {
...
// 2. НЭВТРЭХ ХЭСЭГ (Role шалгалтыг тодорхой болгосон)
function loginUser() {
...
// 4. ПРОФАЙЛ ЗАСВАРЛАХ (Чиний өмнөх функцүүд)
